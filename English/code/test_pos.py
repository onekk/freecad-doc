...
print("Cyl 1st Placement{}".format(obj_1.Placement))

obj_2 = base_cyl("trans_cylinder", 360, 2, 10)
obj_2.Placement = Placement(Vector(10,10,0), ROT0)

print("Cyl 2nd Placement{}".format(obj_2.Placement))

for idx, angle in enumerate((0,45, 90, 135, 180)):
    name = "t_cyl{}".format(idx)
    obj_3 = base_cyl(name, 360, 2, 10)
    pos_3 = Placement(VZOR, Rotation(angle,0,0), Vector(0,0,0))
    tra_3 = Placement(Vector(0,15,0), ROT0)

    obj_3.Placement = pos_3.multiply(tra_3)

    print("{} Placement{}".format(name, obj_3.Placement))
